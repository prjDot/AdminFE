...
import { Menu, Bell, AlertCircle, FileText, User as UserIcon, LogOut } from "lucide-react";
          ...
          <PopoverContent className="w-[calc(100vw-2rem)] max-w-80 p-0" align="end">
            ...
            <div className="max-h-[300px] overflow-y-auto">
              {mockNotifications.map((note) => (
                <Link key={note.id} to={note.to} className="flex gap-3 border-b p-4 transition-colors last:border-0 hover:bg-muted/50">
